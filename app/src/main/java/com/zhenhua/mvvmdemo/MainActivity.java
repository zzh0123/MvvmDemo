...
import com.zhenhua.mvvmdemo.view.ThirdFragment;
...
//    private TextView titleTv;
    // 定义4个Fragment对象
    private FirstFragment shoppingMallFragment;
    private FirstFragment batchingFragment;
    private ThirdFragment extensionFragment;
    private SecondFragment myFragment;
...
//        titleTv.setText("首 页");
    ...
    private void setChioceItem(int index) {
        ...
        switch (index) {
            case 0:
                img_first.setImageResource(R.mipmap.ic_launcher); // 需要的话自行修改
...
//                ll_first.setBackgroundColor(gray);
                ...
                if (shoppingMallFragment == null) {
                    shoppingMallFragment = new FirstFragment();
                ...
                break;
            case 1:
                img_second.setImageResource(R.mipmap.ic_launcher);
...
//                ll_second.setBackgroundColor(gray);
                if (batchingFragment == null) {
                    batchingFragment = new FirstFragment();
...
//                ll_third.setBackgroundColor(gray);
                ...
                break;
            case 3:
                img_fourth.setImageResource(R.mipmap.ic_launcher);
                tv_fourth.setTextColor(getResources().getColor(R.color.colorAccent));
//                ll_fourth.setBackgroundColor(gray);
    ...
    private void clearChioce() {
        img_first.setImageResource(R.mipmap.ic_launcher);
        tv_first.setTextColor(getResources().getColor(R.color.colorAccent));
...
//        ll_fourth.setBackgroundColor(whirt);
    ...
    public void onAttachFragment(Fragment fragment) {
        ...
        if (shoppingMallFragment == null && fragment instanceof FirstFragment) {
            shoppingMallFragment = (FirstFragment) fragment;
            getSupportFragmentManager().beginTransaction().hide(shoppingMallFragment).commit();
        } else if (batchingFragment == null && fragment instanceof FirstFragment) {
            batchingFragment = (FirstFragment) fragment;
            getSupportFragmentManager().beginTransaction().hide(batchingFragment).commit();
        } else if (extensionFragment == null && fragment instanceof ThirdFragment) {
            extensionFragment = (ThirdFragment) fragment;
            getSupportFragmentManager().beginTransaction().hide(extensionFragment).commit();
        } else if (myFragment == null && fragment instanceof SecondFragment) {
            myFragment = (SecondFragment) fragment;
